...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "info@huyafrica.tech",
    href: "mailto:info@huyafrica.tech",
  },
  {
    icon: Phone,
    label: "Phone",
            ...
            <div className="mx-auto grid max-w-5xl gap-12 lg:grid-cols-5 lg:gap-16">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-10 aspect-video overflow-hidden rounded-2xl border border-border bg-muted">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d255282.35853743783!2d36.68257449999999!3d-1.3028617999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f1172d84d49a7%3A0xf7cf0254b297924c!2sNairobi%2C%20Kenya!5e0!3m2!1sen!2sus!4v1706000000000"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
